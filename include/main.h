...
extern int pca9685PWMReadSingle(int pin, int *data);
extern int pca9685PWMReadSingleOff(int pin, int *off);
extern int pca9685PWMReadMulti(int* pin, int data[][2], int num);
extern int pca9685PWMReadMultiOff(int* pin, int *data, int num);
extern void pca9685PWMWriteSingle(int pin, int *data);
extern void pca9685PWMWriteSingleOff(int pin, int off);
extern void pca9685PWMWriteMulti(int *pin, int data[][2], int num); // if pin = 0, num = 3, data will be : on_0, off_0, on_1, off_1, on_2, off_2
